...
<div class="col-12 col-sm-6 col-md-5 col-lg-4 mb-5">
   <div class="card card-tariffs position-relative mb-3">   
      <h5 class="card-header card-tariffs__heder {$positionCard == 'left' ? 'header-left py-6 px-6' : ''} {$positionCard == 'center' ? 'header-center py-6 px-6' : ''} {$positionCard == 'right' ? 'header-right py-6 px-6' : ''} font-size-27 text-center text-white font-weight-montserrat-800 " style="min-height:7.063rem;">
         {$menutitle} </h4>
      <div class="card-body">
