<header class="header z-5">
   <nav class="navbar navbar-expand-lg container-xxl bg-transparent">
         <div class="row justify-content-between align-items-center w-100 no-gutters">
            <div class="col-7 col-sm-5 col-md-4 col-lg-3 pe-md-3 px-lg-2 mb-0 order-1 order-lg-0">
               <a class="navbar__logo h6 d-flex align-items-end font-weight-montserrat-700 text-white text-break mb-0"
                  href="/">
                  {if '+logo' | placeholder}
                  <img src="{'+logo' | placeholder}" class="img-fluid d-block mx-auto pe-3 w-40" alt="{'+logo-text' | placeholder}" title="{'+logo-text' | placeholder}" loading="lazy">{'+logo-text' | placeholder}</a>
               {/if}
            </div>
		...
		"displayStart" => 1,
            ...
            <div class="col-auto collapse navbar-collapse">
               ...
               <a class="navbar__logo d-flex flex-wrap-reverse align-items-center font-weight-montserrat-400 font-size-10 text-break "
                  ...
                  <img src="{"+logo" | placeholder}" class="img-fluid d-block ms-1"style="width: 8%;background: #6a087f;padding: 3px 21px;"
               ...
               'tplInner' => '@INLINE {$wrapper}',
                ...
                <a class="" href="{$link}" >
                               <h6 class="text-indigo h5 fw-bold ps-2 pb-4 mx-3">{$menutitle}</h6></a>
            ...
            <div class="col-auto mb-0 order-2 order-lg-3 pe-0">
