        ...
        <div class="row align-items-center justify-content-center">
            <div id="clientsReviewsIndicators" class="carousel slide" data-ride="carousel">
                ...
                {foreach $rows as $index => $row}                    
                        <li data-target="#clientsReviewsIndicators" data-slide-to="{$index}" class="{$index == '0' ? 'active' : '' }"></li>
                {/foreach}
                </ol>
                ...
                {/foreach}       
                 ...
                 <a class="carousel-control-prev" href="#clientsReviewsIndicators" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                  </a>
                  <a class="carousel-control-next" href="#clientsReviewsIndicators" role="button" data-slide="next">
