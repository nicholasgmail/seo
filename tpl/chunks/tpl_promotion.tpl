...
{if $row}
<div class="col-6 col-sm-4 col-lg-3 px-2 mb-md-5">
    <div class="card border-0 card-promotion position-relative overflow-hidden mb-3">
        ...
        <div class="card-body text-center p-3 p-lg-4">
         ...
         <h6 class="card-title font-size-sm-12 font-weight-montserrat-900 text-center text-uppercase my-3 my-lg-6">{$row['title']}</h6>
            {$row['description']}
        </div>
    </div>
</div>
